...
namespace SistemaFinanceiro.Api.Migrations
{
    ...
    [Migration("20260627003432_AddContasBancarias")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaFinanceiro.Api.Models.CompraParcelada", b =>
                {
                    ...
                    b.Property<bool>("IsDividida")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_dividida");

                    b.Property<decimal?>("PercentualDivisao")
                        .HasPrecision(5, 2)
            ...
            modelBuilder.Entity("SistemaFinanceiro.Api.Models.ConfiguracoesUsuario", b =>
                {
                    b.Property<Guid>("UsuarioId")
                        .HasColumnType("uuid")
                        .HasColumnName("id_usuario");

                    b.Property<bool>("AvisarMelhorDia")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.Property<decimal>("PercentualPadraoDivisao")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)")
                        .HasDefaultValue(50m)
            ...
            modelBuilder.Entity("SistemaFinanceiro.Api.Models.ContaBancaria", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("SistemaFinanceiro.Api.Models.Notificacao", b =>
                {
                    ...
                    b.HasIndex("UsuarioId", "TipoNotificacao", "Titulo", "DataCriacao");
            ...
            modelBuilder.Entity("SistemaFinanceiro.Api.Models.Transacao", b =>
                {
                    ...
                    b.HasIndex("UsuarioId", "ContaBancariaId", "DataOcorrencia");
            ...
            modelBuilder.Entity("SistemaFinanceiro.Api.Models.ConfiguracoesUsuario", b =>
                {
                    b.HasOne("SistemaFinanceiro.Api.Models.Usuario", "Usuario")
                        ...
                        .HasForeignKey("SistemaFinanceiro.Api.Models.ConfiguracoesUsuario", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
