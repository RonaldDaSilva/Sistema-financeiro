...
builder.Services.AddScoped<IContatoDivisaoService, ContatoDivisaoService>();
builder.Services.AddScoped<IDivisaoTransacaoService, DivisaoTransacaoService>();
builder.Services.AddScoped<ITransacaoService, TransacaoService>();
builder.Services.AddScoped<IExportacaoService, ExportacaoService>();
builder.Services.AddScoped<IContatoEmprestimoService, ContatoEmprestimoService>();
